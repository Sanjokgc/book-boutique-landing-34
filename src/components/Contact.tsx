      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Step into our world of books and discover your next great read. 
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <Card className="text-center group hover:shadow-elegant transition-all duration-300">
            <CardContent className="p-8">
              ...
              <h3 className="font-display font-bold text-xl text-primary mb-3">Location</h3>
          ...
          <Card className="text-center group hover:shadow-elegant transition-all duration-300">
            <CardContent className="p-8">
              ...
              <h3 className="font-display font-bold text-xl text-primary mb-3">Hours</h3>
          ...
          <Card className="text-center group hover:shadow-elegant transition-all duration-300">
            <CardContent className="p-8">
              ...
              <h3 className="font-display font-bold text-xl text-primary mb-3">Contact</h3>
              <div className="text-muted-foreground space-y-1">
                <p>(555) 123-BOOK</p>
                <p>hello@literarycorner.com</p>
                <p>@LiteraryCornerBooks</p>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="text-center">
          <Button variant="literary" size="lg" className="mr-4">
            Get Directions
          </Button>
